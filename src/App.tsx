...
export default function App() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen w-full bg-[#F8FAFC] font-sans text-slate-900 antialiased">
      {/* Sidebar */}
<aside className="w-full md:w-72 bg-white border-b md:border-r border-slate-200 p-5 md:p-6 flex flex-col gap-8 max-h-[45vh] md:max-h-none md:h-screen md:sticky top-0 overflow-y-auto z-20 shadow-sm shrink-0">      <div className="flex items-center gap-3">
